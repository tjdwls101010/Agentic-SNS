...
def insiders_page(rows=(("ENLT", "Paz Amit", "2108367", "CHIEF INNOVATION OFFICER", "Sep 12 '26", "Sale", "42.10", "10,000", "421,000", "50,000", "Sep 14 09:55 PM", "http://www.sec.gov/Archives/edgar/data/1/x.xml"),), transaction="insidertrading?tc=7"):
    head = '<th class="table-header cursor-pointer" onclick="window.location=\'insidertrading?tc=7&o=-ticker\'">Ticker</th>' + "".join('<th class="table-header is-static">%s</th>' % h for h in ("Owner", "Relationship", "Date", "Transaction", "Cost", "#Shares", "Value ($)", "#Shares Total", "SEC Form 4"))
